                ...
                <div class="flex justify-center w-full">
                    <table class=" w-3/4">
                            <tbody>
                                ...
                                <!-- no trecho abaixo, foi adicionado o id do usuário  como comparação na condição -->
                                    @if(!empty($message != null && $message->recipient_id == null ))
                                    ...
                                    <td class="text-right p-2" style="border-bottom: 1px solid DodgerBlue;">
                                        ...
                                        <input type="radio" style="border-color: DodgerBlue;" name="selectedMessage" value="{{ $message->id }}">
                                            ...
                                            <div class="flex justify-end">
                                                ...
                                                <a href="{{ route('deletar_message', ['id' => $message->id]) }}" class="inline-block w-8 h-8"><img src="https://cdn-icons-png.flaticon.com/512/4140/4140207.png" class="w-8 h-8" alt="Excluir"></a>
