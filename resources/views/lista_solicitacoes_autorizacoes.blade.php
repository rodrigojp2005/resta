            ...
            <div class="bg-white h-screen overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form id="meuFormulario" onsubmit="handleSubmit(event)" action="{{ route('salvar_autorizacoes') }}" method="POST">
                    ...
                    @foreach ($autorizacoes as $autorizacao)
                        @if($autorizacao->autorizador_id != Auth::id())
                        <!-- <div class="flex items-center justify-between border-b border-gray-200 p-4">
                            ...
                            <div class="flex items-center mr-8">
                                ...
                                <button type="button" class="ml-2 text-gray-500 focus:outline-none" aria-label="Fechar" onclick="hideRow(this)">
