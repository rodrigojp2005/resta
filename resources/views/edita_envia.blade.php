                                ...
                                <tr>
                                    <td class="text-right p-2" style="border-bottom: 1px solid lightgray;">
                                        <div class="flex justify-between">
                                            <span class="truncate text-left text-blue-600" style="overflow-wrap: break-word;color:DodgerBlue;">{{ $texto->titulo }} </span>
                                            <div class="flex justify-end">
                                                ...
                                                <a href="{{ route('deletar_texto', ['id' => $texto->id]) }}" class="inline-block w-8 h-8"><img src="https://img.icons8.com/?size=512&id=32555&format=png" class="w-8 h-8" alt="Enviar"></a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
